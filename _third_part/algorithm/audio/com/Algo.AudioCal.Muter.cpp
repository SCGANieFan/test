...
void Muter_c::Init(MemoryManger_c* MM, AudioInfo* info, WindowChoose_e windowChoose, DirChoose_e dirChoose, i32 decaySamples) {
	_productCh = Product_c::GetFunc_FixedPoint(Product_c::FuncMode_e::PRODUCT_CH_WITH_FIXED_POINT, info->_width, sizeof(i16));
	_productAllCh = Product_c::GetFunc_FixedPoint(Product_c::FuncMode_e::PRODUCT_WITH_FIXED_POINT, info->_width, sizeof(i16));
	_info = info;
	_facFpNum = 14;
