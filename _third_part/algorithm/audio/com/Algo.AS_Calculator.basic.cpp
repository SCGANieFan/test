...
{
	return ((AppendInFixPoint_CB)((FuncList*)_funcList)->appendInFixPoint_cb)(as, num, den);
}
...
{
	return ((LeftShift_CB)((FuncList*)_funcList)->leftShift_cb)(as, startSample, samples, bits);
}
...
{
	return ((LeftShiftSigned_CB)((FuncList*)_funcList)->leftShiftSigned_cb)(as, startSample, samples, bits);
}
...
{
	return ((RightShift_CB)((FuncList*)_funcList)->RightShift_cb)(as, startSample, samples, bits);
}
...
{
	return ((RightShiftSigned_CB)((FuncList*)_funcList)->RightShiftSigned_cb)(as, startSample, samples, bits);
}
