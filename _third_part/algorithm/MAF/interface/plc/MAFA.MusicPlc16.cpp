...
{
	MAF_Object::Registe<MAFA_MusicPlc16>("music_plc16");
}

MAFA_MusicPlc16::MAFA_MusicPlc16()
{
}
MAFA_MusicPlc16::~MAFA_MusicPlc16()
{
...
maf_int32 MAFA_MusicPlc16::Init()
{
	MAF_PRINT();
...
maf_int32 MAFA_MusicPlc16::Deinit()
{
	MAF_PRINT();
	MusicPlc16bStateDeInit(_hd);
	MAF_PRINT("_hd=%x", (unsigned)_hd);
	_memory.Free(_hd);
	return 0;
}

maf_int32 MAFA_MusicPlc16::Process(MAF_Data* dataIn, MAF_Data* dataOut)
{
	maf_int32 inUsed = 0;
	maf_int32 ret;
...
maf_int32 MAFA_MusicPlc16::Set(const maf_int8* key, maf_void* val)
{
...
maf_int32 MAFA_MusicPlc16::Get(const maf_int8* key, maf_void* val)
{
